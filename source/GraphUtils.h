...
struct Graph
{
	...
	void Render(SDL_Renderer* renderer, Vector2D graphOrigin, Uint32 graphColor, float factor = 1.0f, float delta = 0.0f);
	void DrawPath(SDL_Renderer* renderer, Vector2D graphOrigin, std::vector<int> path, Uint32 graphColor, float factor = 1.0f, float delta = 0.0f);
};
